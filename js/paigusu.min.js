(function (c, f, h, k) {
    ...
    g.prototype = {
        ...
        setInputColor: function () {
            ...
            c("#color-block").css("background", "rgba(" + d + ")");
...
$(".eye").click(function(){
    ...
    $(this).attr("src","img/icon/eye2.png");
        }
    else{
